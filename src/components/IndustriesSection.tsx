...
import { Building2, Factory, Banknote, Smartphone, Heart, GraduationCap, ShoppingCart, Users } from "lucide-react";
          ...
          {industries.map((industry, index) => (
            ...
            >
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg font-bold text-gray-900 transition-colors leading-tight">
                  {industry.title}
                </CardTitle>
              </CardHeader>
